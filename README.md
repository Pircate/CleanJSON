...
可以通过 typeConvertionStrategy 自定义类型转换，仅在类型不一致的时候生效，默认支持[这些](https://github.com/Pircate/CleanJSON/blob/master/CleanJSON/Classes/TypeConvertionStrategy.swift)类型转换
